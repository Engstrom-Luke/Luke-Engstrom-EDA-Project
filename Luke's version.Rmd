...
```{r Oceanic Ray, echo=FALSE, message=FALSE, warning=FALSE}
...
ggplot() +
  ...
  guides(fill = "none") +
  labs(
    title = "Figure 1. Oceanic Ray Global Sightings"
  )
```

```{r Reef Breeding Season, echo=FALSE, message=FALSE, warning=FALSE}
...
ggplot() +
  ...
  guides(fill = "none") +
  labs(
    title = "Figure 2. Breeding Season Sightings"
  )
```

```{r Reef Ray Global, echo=FALSE, message=FALSE, warning=FALSE}
# Reef Ray World Map
library(rinat)
library(tidyverse)
...
ggplot() +
  ...
  guides(fill = "none") +
  labs(
    title = "Figure 3. Reef Ray Global Sightings"
  )
```

```{r Ocean Density, echo=FALSE, message=FALSE, warning=FALSE}
...
ggplot() +
  ...
  guides(fill = "none") +
  labs(
    title = "Figure 4. Oceanic Ray Global Sightings",
    caption="Lighter colors indicate denser sightings"
  )
```

```{r Bredding density, echo=FALSE, message=FALSE, warning=FALSE}
...
ggplot() +
  ...
  guides(fill = "none") +
  labs(
    title = "Figure 5. Density of Reef Ray Breeding Season",
    caption="Lighter colors indicate denser sightings"
  )
```

```{r Density Reef Ray, echo=FALSE, message=FALSE, warning=FALSE}
...
ggplot() +
  ...
  guides(fill = "none") +
  labs(
    title = "Figure 6. Reef Ray Global Sightings",
    caption="Lighter colors indicate denser sightings"
  )
```
